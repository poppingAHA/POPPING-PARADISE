<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="regUser.aspx.cs" Inherits="POPPING_PARADISE成员管理系统.user.regUser" %>
    ...
    <div>   
        ...
        <table style="margin-left:100px;">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Button ID="Button1" runat="server" Text="注册" BackColor="#A55129" BorderColor="#DEBA84" BorderWidth="3px" Font-Bold="True" ForeColor="White" Width="88px" OnClick="Button1_Click" />
                </td>
            </tr>
        </table>
    </div>
